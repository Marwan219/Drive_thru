...
class PreSurvey extends StatefulWidget {
  @override
  PreSurveyState createState() {
    // TODO: implement createState
    return PreSurveyState();
  }
}

class PreSurveyState extends State<PreSurvey>
...
//                    color: Colors.orangeAccent,
  ...
  List<ThirdQuestion> thirdQuestionList = [
    ThirdQuestion('Better coustmer service', false),
    ThirdQuestion('Adding more regions to cover', false),
    ThirdQuestion('Making the service faster', false),
    ThirdQuestion('Adding more restaurants to our network', false),
  ];
