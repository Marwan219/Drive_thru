...
import '../services/SurveyManagement.dart';
//import 'images';
...
class SurveyState extends State<Survey>
  ...
  finish() {
    ...
    // add data  
    SurveyManagement().addNewAnswer(answer1: this.overallStatus,answer2:this.q2answers,answer3: this.usingTimes,answer4: this.q4answers,context: context);
                        ...
                        child: Column(
                          children: List.generate(usingCollection.length,
                            ...
                            return GestureDetector(
                              onTapUp: (detail) {
                                setState(() {                           
                                  usingTimes = using.displayContent;
                            ...
                            return Column(
                              children: <Widget>[
                                GestureDetector(
                                  onTapUp: (detail) {
//                                     setState(() {
//                                       question.isSelected? q2answers.add(question.displayContent):q2answers.remove(question.displayContent);
...
//                                          print(value);
                                              setState(() {
                                                ...
                                                value ? q2answers.add(question.displayContent):q2answers.remove(question.displayContent);
                            ...
                            return Column(
                              children: <Widget>[
                                GestureDetector(
                                  onTapUp: (detail) {
//                                     setState(() {
//                                         question.isSelected ? q4answers.add(question.displayContent):q4answers.remove(question.displayContent);
//                                       question.isSelected =
//                                           !question.isSelected;
// //                                  isFairly = !isFairly;
//                                     });
                                       ...
                                       showDialog(
                                        ...
                                        builder: (_) => new AlertDialog(
                                            ...
                                            Text("OK"))
                                                 ...
                                                 value ? q4answers.add(question.displayContent):q4answers.remove(question.displayContent);
                                                question.isSelected = value;
                                              });
                                            }),
                                        Text(question.displayContent)
...
//                height: 10.0,
            ...
            Opacity(
              ...
              child: Column(
                ...
                children: <Widget>[
                  Image.asset('images/logotempoo.png', width: MediaQuery.of(context).size.width * 0.35, height: MediaQuery.of(context).size.height * 0.55 ),
                  Text(
